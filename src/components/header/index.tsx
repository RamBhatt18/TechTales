...
export default function Header() {
  ...
  return (
    <div>
      <header
        className={`z-40 top-0 left-0 flex w-full items-center bg-transparent ${
          sticky
      ...
      >
        ...
        `}
                ...
                <nav
                  id="navbarCollapse"
                  className={`absolute right-0 z-30 w-[250px] rounded border-[.5px] bg-white border-body-color/50 py-4  px-6 duration-300 dark:border-body-color/20 dark:bg-dark
